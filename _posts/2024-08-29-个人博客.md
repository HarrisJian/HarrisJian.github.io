...
> [!前言]
> 随着接触的知识越来越多，大脑容量感觉严重不足，考虑构建自己的知识体系，尝试过博客园、语雀、知识库等诸多软件，经历过服务器宕机、文章丢失等情况，下定决心要构建自己的博客。
...
github config页签配置github参数，主要是配置用户名、仓库名、分支以及自己的TOKEN。
![EnveLoppe_3.jpg](../assets/img/posts/StarterSeries/20240829/EnveLoppe_3.jpg)

File paths页签配置本地markdown文章推送到远程仓库目录，我这里配置的是_posts。
![EnveLoppe_4.jpg](../assets/img/posts/StarterSeries/20240829/EnveLoppe_4.jpg)

Content页签配置本地markdown文章发送到远程之前对其内容进行转换。
![EnveLoppe_5.jpg](../assets/img/posts/StarterSeries/20240829/EnveLoppe_5.jpg)

Attachment & embeds页签配置决定本地attachments目录下的附件发送到远程repository的目录。
